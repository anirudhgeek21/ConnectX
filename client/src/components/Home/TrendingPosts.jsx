        ...
        <Fragment>
            {selectedPost && (
                <motion.div
                    ...
                    className="fixed top-0 md:left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 z-50"
                    onClick={handleCloseModal}
                >
                    <motion.div
                        className="bg-white rounded-lg shadow-lg h-[60%] p-4 w-[80%] sm:w-[20%] lg:w-[60%] md:h-[80%] md:max-h-full overflow-y-auto"
                    ...
                    >
                        ...
                        <form onSubmit={handleCommentSubmit} className="my-4">
                            ...
                            />
                            <button type="submit" className="w-full bg-blue-500 text-white py-2 rounded mt-2">Submit</button>
                        </form>
                        <div className="mt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 py-8 px-4 gap-4 md:mx-5 md:gap-10">
                {postsData.map(post => (
                    <motion.div
                        key={post.id}
                        initial={{ opacity: 0 }}
